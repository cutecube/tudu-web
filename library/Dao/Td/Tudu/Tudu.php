 ...
 * @version    $Id: Tudu.php 2771 2013-03-11 03:50:01Z cutecube $
 */
...
class Dao_Td_Tudu_Tudu extends Oray_Dao_Abstract
{
    ...
    public function getTudu(array $condition, $filter = null)
    {
        ...
        $table   = "td_tudu t "
                 ...
                 . "LEFT JOIN td_tudu_step st ON st.tudu_id = t.tudu_id AND st.step_id = t.step_id ";

        $columns = "t.org_id AS orgid, t.board_id AS boardid, t.tudu_id AS tuduid, t.cycle_id AS cycleid, t.prev_tudu_id AS prevtuduid, "
                 . "t.type, t.subject, t.from, t.to, t.cc, t.bcc, t.priority, t.privacy, t.password, t.is_auth AS isauth, t.step_id AS stepid, "
                 ...
                 . "t.step_num as stepnum, t.percent, t.score, t.status, t.special, t.notify_all AS notifyall, t.accep_mode AS accepmode,"
    ...
    public function getGroupTudus(array $condition, $filter = null, $sort = null, $maxCount = null)
    {
        ...
        $columns = "t.org_id AS orgid, t.board_id AS boardid, t.tudu_id AS tuduid, t.cycle_id AS cycleid, t.prev_tudu_id AS prevtuduid, "
                 . "t.type, t.subject, t.from, t.to, t.cc, t.priority, t.privacy, t.password, t.step_id AS stepid, "
    ...
    public function getTuduPage(array $condition = null, $sort = null, $page = null, $pageSize = null)
    {
        ...
        $columns = "t.org_id AS orgid, t.board_id AS boardid, t.tudu_id AS tuduid, t.cycle_id AS cycleid, t.prev_tudu_id AS prevtuduid, "
                 . "t.type, t.subject, t.from, t.to, t.cc, t.priority, t.privacy, t.password, t.step_id AS stepid, t.app_id AS appid, "
                 ...
                 . "g.type AS nodetype, g.parent_tudu_id AS parentid, st.type AS steptype";
        $primary = "t.tudu_id";
        ...
        if (isset($condition['label'])) {
            ...
            if ($condition['label'] == '^e') {
                $table .= ' LEFT JOIN td_tudu_step_user tsu ON tsu.tudu_id = t.tudu_id AND tsu.unique_id = tu.unique_id AND tsu.step_id = t.step_id';
                $columns .= ", tsu.status AS selfstepstatus";
            }
        }
    ...
    public function updateFlowProgress($tuduId, $uniqueId, $stepId, $percent = null, &$flowPercent = null)
    {
        ...
        $sql   = "SELECT step_id as stepid, step_status, type FROM td_tudu_step WHERE tudu_id = :tuduid ORDER BY order_num ASC";

        $steps = $this->_db->fetchAll($sql, array('tuduid' => $tuduId));
        ...
        if (0 == $type) {
            ...
            $sql     = "SELECT process_index, status FROM td_tudu_step_user WHERE tudu_id = :tuduid AND step_id = :stepid ORDER BY process_index ASC";
            $users   = $this->_db->fetchAll($sql, array('tuduid' => $tuduId, 'stepid' => $stepId));
