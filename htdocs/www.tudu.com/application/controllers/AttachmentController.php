 ...
 * Upload Controller
 *
 * @version $Id: AttachmentController.php 2787 2013-03-20 10:52:53Z chenyongfa $
 */
...
class AttachmentController extends TuduX_Controller_Base
{
    ...
    public function imgAction()
    {
        ...
        if (empty($this->options['sites']['file'])) {
        ...
        $url = $this->options['sites']['file']
             ...
             . "?sid={$sid}&fid={$fid}&auth={$auth}&email={$this->_user->userName}&action=view";
