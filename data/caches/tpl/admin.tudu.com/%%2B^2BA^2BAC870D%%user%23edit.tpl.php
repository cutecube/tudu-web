<?php /* Smarty version 2.6.26, created on 2013-03-15 16:01:13
         compiled from user/user%23edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'user/user#edit.tpl', 15, false),array('modifier', 'rand', 'user/user#edit.tpl', 23, false),array('modifier', 'str_replace', 'user/user#edit.tpl', 74, false),array('modifier', 'round', 'user/user#edit.tpl', 82, false),array('modifier', 'format_file_size', 'user/user#edit.tpl', 82, false),array('modifier', 'date_format', 'user/user#edit.tpl', 134, false),array('modifier', 'replace', 'user/user#edit.tpl', 179, false),array('modifier', 'escape', 'user/user#edit.tpl', 179, false),array('function', 'math', 'user/user#edit.tpl', 82, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="title-bar"><strong class="f14 text-title">修改帐号信息</strong> | <a href="<?php if ($this->_tpl_vars['back']): ?><?php echo $this->_tpl_vars['back']; ?>
<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['basepath'])) ? $this->_run_mod_handler('cat', true, $_tmp, '/user/user') : smarty_modifier_cat($_tmp, '/user/user')); ?>
<?php endif; ?>">返回</a></div>
<?php if ($this->_tpl_vars['user']['unlocktime'] > time()): ?>
<div class="msgbox" style="margin-top:5px;" id="lockinfo"><p class="red">登录时连续输入<?php echo $this->_tpl_vars['org']['locktime']; ?>
次错误密码，导致帐号被锁定 <a href="javascript:void(0)" id="unlock">点击解锁</a></p></div>
<?php endif; ?>
<form action="<?php echo $this->_tpl_vars['basepath']; ?>
/user/user/update" id="theform" method="post">
<input type="hidden" name="userid" id="userid" value="<?php echo $this->_tpl_vars['user']['userid']; ?>
" />
    <table id="user-base" border="0" cellspacing="2" cellpadding="3" class="table-form table-form-f12" style="margin-top:20px;">
        <tr>
            <th style="padding-bottom:20px;" width="110" align="right"><a href="javascript:void(0)" name="avatar"><img id="avatar-img" src="<?php echo $this->_tpl_vars['options']['sites']['www']; ?>
/logo?unid=<?php echo $this->_tpl_vars['user']['uniqueid']; ?>
&rnd=<?php echo ((is_array($_tmp=0)) ? $this->_run_mod_handler('rand', true, $_tmp, 999999) : rand($_tmp, 999999)); ?>
" width="40" height="40" style="border:none" /></a></th>
        ...
        <tr>
            ...
            <td><input name="truename" type="text" class="text" id="truename" value="<?php echo $this->_tpl_vars['userinfo']['truename']; ?>
" style="width:250px" /></td>
        ...
        <tr>
            ...
            <td><select name="status" style="width:256px;"><option value="1"<?php if ($this->_tpl_vars['user']['status'] == 1): ?> selected="selected"<?php endif; ?>>正式</option><option value="2"<?php if ($this->_tpl_vars['user']['status'] == 2): ?> selected="selected"<?php endif; ?>>临时</option><option value="0"<?php if ($this->_tpl_vars['user']['status'] === 0): ?> selected="selected"<?php endif; ?>>停用</option></select></td>
        </tr>
        <tr>
            <th align="right">性别：</th>
            <td><select name="gender" style="width:256px;"><option value="1"<?php if ($this->_tpl_vars['userinfo']['gender'] == 1): ?> selected="selected"<?php endif; ?>>男</option><option value="0"<?php if ($this->_tpl_vars['userinfo']['gender'] == 0): ?> selected="selected"<?php endif; ?>>女</option></select></td>
        </tr>
        <tr>
...
"<?php if ($this->_tpl_vars['user']['deptid'] == $this->_tpl_vars['item']['deptid']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['prefix']; ?>
...
"<?php if (in_array ( $this->_tpl_vars['item']['roleid'] , $this->_tpl_vars['user']['roles'] )): ?> checked="checked"<?php endif; ?> /><?php echo $this->_tpl_vars['item']['rolename']; ?>
        ...
        <tr>
            ...
            <td>
                <p><input name="maxndquota" type="text" class="text" size="10" value="<?php echo ((is_array($_tmp=smarty_function_math(array('equation' => "x/1000000",'x' => $this->_tpl_vars['user']['maxndquota']), $this))) ? $this->_run_mod_handler('round', true, $_tmp, 1) : round($_tmp, 1));?>
" style="ime-mode:disabled" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)" onblur="this.v();" />&nbsp;MB, 已使用 <span class="red"><?php echo ((is_array($_tmp=$this->_tpl_vars['quotaused'])) ? $this->_run_mod_handler('format_file_size', true, $_tmp) : $this->_plugins['modifier']['format_file_size'][0][0]->formatFileSize($_tmp)); ?>
</span></p>
                <p style="margin-top:8px;">剩余可分配空间为 <strong><?php echo ((is_array($_tmp=$this->_tpl_vars['avaliblequota'])) ? $this->_run_mod_handler('format_file_size', true, $_tmp, 1000) : $this->_plugins['modifier']['format_file_size'][0][0]->formatFileSize($_tmp, 1000)); ?>
</strong></p>
            </td>
        </tr>
        <tr>
    ...
    <table id="info" style="margin:0 0 40px 25px;" border="0" cellspacing="2" cellpadding="3" class="table-form table-form-f12">
        <tr>
            ...
            <td>
                <p><label for="yes"><input id="yes" checked="checked" name="isshow" type="radio" value="1"<?php if ($this->_tpl_vars['user']['isshow']): ?> checked="checked"<?php endif; ?> />是</label>&nbsp;&nbsp;显示排序为 <input name="ordernum" type="text" class="text" size="10" value="<?php echo $this->_tpl_vars['user']['ordernum']; ?>
" /> <span class="gray" id="hint-order">输入的数字越大，排序越靠前</span></p>
                <p style="margin-top:8px;"><label for="no"><input id="no" name="isshow" type="radio" value="0"<?php if (! $this->_tpl_vars['user']['isshow']): ?> checked="checked"<?php endif; ?> />否</label></p>
            </td>
        </tr>
        <tr>
            <th align="right"><label for="position">职位：</label></th>
            <td><input name="position" type="text" id="position" class="text" value="<?php echo $this->_tpl_vars['userinfo']['position']; ?>
...
"<?php if (in_array ( $this->_tpl_vars['item']['groupid'] , $this->_tpl_vars['user']['groups'] )): ?> checked="checked"<?php endif; ?> /><?php echo $this->_tpl_vars['item']['groupname']; ?>
</label></p>
                <?php endforeach; endif; unset($_from); ?>
                </div>
        ...
        <tr>
            ...
            <td><input id="user-email" name="email" value="<?php echo $this->_tpl_vars['userinfo']['mailbox']; ?>
" type="text" class="text" style="width:250px;" /></td>
        </tr>
        <tr>
            <th align="right"><label for="id-number">身份证号：</label></th>
            <td><input id="id-number" name="idnumber" value="<?php echo $this->_tpl_vars['userinfo']['idnumber']; ?>
" type="text" class="text" style="width:250px" /></td>
        </tr>
        <tr>
...
" <?php if ($this->_tpl_vars['userinfo']['birthmonth'] - 1 == $this->_sections['month']['index']): ?> selected="selected"<?php endif; ?>><?php echo smarty_function_math(array('equation' => "x+1",'x' => $this->_sections['month']['index']), $this);?>
        ...
        <tr>
            ...
            <td><input id="mobile" name="mobile" value="<?php echo $this->_tpl_vars['userinfo']['mobile']; ?>
" type="text" class="text"  style="width:250px" maxlength="30" /></td>
        </tr>
        <tr>
            <th align="right"><label for="phone">办公电话：</label></th>
            <td><input id="tel" name="tel" value="<?php echo $this->_tpl_vars['userinfo']['tel']; ?>
" type="text" class="text"  style="width:250px" /></td>
        </tr>
        <tr>
            <th align="right"> </th>
...
<?php $_from = $this->_tpl_vars['cast']['users']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
disableUsers['<?php echo $this->_tpl_vars['key']; ?>
'] = {'userid': '<?php echo $this->_tpl_vars['item']['userid']; ?>
', 'deptid': '<?php echo $this->_tpl_vars['item']['deptid']; ?>
', 'truename': '<?php echo $this->_tpl_vars['item']['truename']; ?>
'};
<?php endforeach; endif; unset($_from); ?>
<?php $_from = $this->_tpl_vars['cast']['depts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
disableDepts['<?php echo $this->_tpl_vars['key']; ?>
'] = {'deptid': '<?php echo $this->_tpl_vars['item']['deptid']; ?>
', 'parentid': '<?php echo $this->_tpl_vars['item']['parentid']; ?>
'};
<?php endforeach; endif; unset($_from); ?>
<?php $_from = $this->_tpl_vars['depts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
...
', checked:<?php if (in_array ( $this->_tpl_vars['item']['deptid'] , $this->_tpl_vars['cast']['depts'] )): ?> true<?php else: ?> false<?php endif; ?>, depth:<?php echo $this->_tpl_vars['item']['depth']; ?>
});
<?php endforeach; endif; unset($_from); ?>
...
$(function() {
    ...
    User.depts = depts;
    User.initEdit();
    $('#bir-day').val(parseInt('<?php echo $this->_tpl_vars['userinfo']['birthdate']; ?>
'));
});
-->
</script>
